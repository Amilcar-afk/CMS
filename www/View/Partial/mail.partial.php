...
<head>
    ...
    <style type="text/css">
        ...
        .background-container-back-office {
            position: absolute;
            height: 40px;
            left: 0px;
            top: 0px;
            overflow: hidden; }
        .background-container-back-office div {
            position: absolute;
            width: 1500px;
            height: 1500px;
            filter: blur(50px); }
        .background-container-back-office div:nth-child(1) {
            left: -186px;
            top: -85px;
            background: linear-gradient(180deg, rgba(var(--third-color-rgb), 0.13) 0%, var(--third-color) 100%); }
        .background-container-back-office div:nth-child(2) {
            left: 1588.1px;
            top: 1606.58px;
            left: 900.1px;
            top: 58.58px;
            background: linear-gradient(180deg, rgba(var(--main-color-rgb), 0.13) 0%, var(--main-color) 100%);
            transform: rotate(-141.76deg); }
        .background-container-back-office div:nth-child(3) {
            left: 1296.89px;
            top: 419.6px;
            background: linear-gradient(180deg, rgba(var(--second-color-rgb), 0.13) 0%, var(--second-color) 100%);
            transform: rotate(152.34deg); }
        .background-container-back-office div:nth-child(4) {
            z-index: 1;
            left: 0px;
            top: 0px;
            width: 100vw;
            height: 100vh;
            background: rgba(135, 116, 116, 0.2);
            box-shadow: inset 0px 0px 250px rgba(255, 255, 255, 0.25);
...
<div class="body-content">
    ...
    <div style="margin:0px auto;max-width:500px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
            <tbody>
            <tr>
                <td style="direction:ltr;font-size:0px;padding:20px 0;padding-top:60;text-align:center;">
                    <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="body-section-outlook" style="" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="body-section-outlook" style="width:500px;" width="500" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                    <div class="body-section" style="-webkit-box-shadow: 1px 4px 11px 0px rgba(0, 0, 0, 0.15); -moz-box-shadow: 1px 4px 11px 0px rgba(0, 0, 0, 0.15); box-shadow: 1px 4px 11px 0px rgba(0, 0, 0, 0.15); margin: 0px auto; max-width: 500px; border-radius:var(--radius, 15px) var(--radius, 15px) 0 0;">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                            <tbody>
                            <tr>
                                <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;padding-top:0;text-align:center;">
                                    <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" width="500px" ><![endif]-->
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                                        <tbody>
                                        <tr>
                                            <td>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;word-break:break-word;">
                                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;letter-spacing:1px;line-height:24px;text-align:center;text-transform:uppercase;color:var(--main-color, #396075);">Austin, TX</div>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
                                    ...
                                    <!--[if mso | IE]></td></tr><tr><td class="" width="500px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:500px;" width="500" bgcolor="#ffffff" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                                    <div style="background:var(--background-color, #ffffff);background-color:var(--background-color, #ffffff);margin:0px auto;max-width:500px;border-radius:0 0 var(--radius, 15px) var(--radius, 15px);">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:var(--background-color, #ffffff);background-color:var(--background-color, #ffffff);width:100%;border-radius: 0 0 var(--radius, 15px) var(--radius, 15px);">
                                            <tbody>
                                            <tr>
                    ...
                    <!--[if mso | IE]></td></tr></table></td><td class="" style="" ><![endif]-->
                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                        <tbody>
                        <tr>
                            <td>
                                ...
                                <div style="margin:0px auto;max-width:500px;">
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                                        ...
                                        <tr>
                                            <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                                                <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" width="500px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:500px;" width="500" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                                                <div style="margin:0px auto;max-width:500px;">
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                                                        <tbody>
                                                        <tr>
                                                ...
                                                <!--[if mso | IE]></td></tr></table></td></tr><tr><td class="" width="500px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:500px;" width="500" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                                                <div style="margin:0px auto;max-width:500px;">
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-top:0;text-align:center;">
                                                                ...
                                                                <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0;line-height:0;text-align:left;display:inline-block;width:100%;direction:ltr;">
                                                                    <!--[if mso | IE]><table border="0" cellpadding="0" cellspacing="0" role="presentation" ><tr><td style="vertical-align:top;width:500px;" ><![endif]-->
                                                                    <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                                            <tbody>
                                                                            <tr>
